...
COPY_PATH = '/home/ubuntu/documents/logs/bitcoin/'
COPIED_PATH = '/home/ubuntu/documents/logs/bitcoin/debug.log'
SHORTER_PATH = '/home/ubuntu/documents/logs/bitcoin/props.log'
TX_PATH = '/home/ubuntu/documents/logs/bitcoin/txs.log'
CONN_PATH = '/home/ubuntu/documents/logs/bitcoin/conns.log'
...
# copy bitcoin log and empty file, then parse copied log
...
PEERS_PATH = '/home/ubuntu/documents/logs/bitcoin/peers/'
PEERS_INTERVAL = 7200
# token for ipinfo.io
TOKEN = 'XXX'
...
CHAINTIP_PATH = '/home/ubuntu/documents/logs/bitcoin/chains/'
CHAINTIP_INTERVAL = 14400


def save_chain_tips():
    result = subprocess.run(['bitcoin-cli', 'getchaintips'], stdout=subprocess.PIPE)
        ...
        for row in cur.execute("select hash from propagation where timestamp>? group by hash", (latest,)):
            ...
            if result and 'error' not in result:
                try:
                    ...
                    continue
                result = subprocess.run(['bitcoin-cli', 'getblockstats', '{}'.format(height)], stdout=subprocess.PIPE)
                result = result.stdout.decode("utf-8")
                try:
                    if result and 'error' not in result:
                        cur2 = conn.cursor()
